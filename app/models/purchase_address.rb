class PurchaseAddress
  ...
  with_options presence: true do
    ...
    validates :post_code, format: {with: /\A[0-9]{3}-[0-9]{4}\z/, message: "Postal code is invalid. Include hyphen(-)"}
    validates :phone_num, format: {with: /\A(0{1}\d{9,10})\z/, message: "Phone number is invalid. Not include hyphen(-)"}
  end
